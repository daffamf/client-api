...
class MapsForm extends Component {
    ...
    render() {
        return (
            <div>
                <button onClick={() => this.handleClickAdd()} className="btn btn-primary mb-3 "><i className="fa fa-plus"></i> add</button>
                <div className={this.state.isVisibleAdd}>
                    <div className="card-body bg-light">
                        <form onSubmit={this.handleClickSave} className="row mb-6">
