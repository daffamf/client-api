        ...
        if (this.state.isEdit) {
            return (
                <tr>
                    ...
                    <td>
                        <input type="text" value={this.props.title} onChange={this.handleInputChange} name="title" className="form-control" />
                    </td>
                    <td>
                        <input type="text" value={this.props.lat} onChange={this.handleInputChange} name="lat" className="form-control" />
                    </td>
                    <td>
                        <input type="text" value={this.props.lang} onChange={this.handleInputChange} name="lang" className="form-control" />
                    </td>
